...
<!-- Mirrored from lineartheme.com/themes/becharity/cause.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2019 12:14:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="page-title-section">
        <div class="page-title-wrap">
            ...
            <div class="page-title-info">
                ...
                <h1 class="page-title">List Of Child</h1>
            </div>
        </div>
    </div>
    ...
    <div class="recent-cause pd-top-100 pd-bottom-100">
        <div class="container">
            <div class="row">
                ...
                $qry="SELECT * FROM child_profile where isactive=1";
                $rs=mysqli_query($conn,$qry);
                while($row=mysqli_fetch_assoc($rs))
                {
                ?>
                <div class="col-sm-4 recent-cause-list">
                    <img src="admin14/<?php echo $row['image'];?>" alt="cause image" height="240">
                    <div class="recent-cause-summary">
                        <div class="recent-cause-content">
                            <h3 class="recent-cause-title"><a href="#"><?php echo $row['name'];?></a></h3>
                            <div class="cause-location">Age :  <?php echo $row['age'];?> Year</div>
                            <div class="cause-tags">Gender : <?php echo $row['gender'];?></div>
                            <a class="btn mg-top-40" href="viewchildprofile.php?id=<?php echo $row['id'];?>">View</a>
                            <a class="btn mg-top-40" href="request.php?id=<?php echo $row['id'];?>">Request for Adoption</a>
                        </div>
...
<!-- Mirrored from lineartheme.com/themes/becharity/cause.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2019 12:14:28 GMT -->
</html>
