...
<!-- Mirrored from lineartheme.com/themes/becharity/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2019 12:16:09 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <title>404 | beCharity HTML5 responsive charity theme</title>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="hidden-xs col-sm-6 col-md-4 col-lg-4">
                        ...
                        <a class="join-top" href="login-2.php"><i class="fa fa-user-circle"></i>JOIN</a>
    ...
    <!-- main content -->
    <div class="error-section mg-top-100 mg-bottom-100">
        <h2 class="error-title">404</h2>
        <p>You may choose a causes below, or browse to find a new popular cause</p>
...
<!-- Mirrored from lineartheme.com/themes/becharity/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Nov 2019 12:16:10 GMT -->
</html>
